...
This repository defines component-level APIs and common configuration formats for the Aeraki Mesh. 
These definitions are specified using the [protobuf](https://github.com/google/protobuf)
syntax.
...
other repositories. Except for tools, all other Aeraki repositories can take a dependency on the api repository.
